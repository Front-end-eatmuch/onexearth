...
function CasinoJackpotSlider(props) {
	...
	const handleClick = () => {
		...
		window.location.replace("/casino/jackpot");
	};
	return (
		<div>
			<div className=' relative bg-amber-800 w-full overflow-x-hidden py-5 px-5 space-y-5'>
				...
				<Swiper
					...
					navigation={{
						prevEl: navigationNextRef2.current,
						nextEl: navigationPrevRef2.current,
					}}
					spaceBetween={10}
					pagination={{
						type: "fraction",
...
export default CasinoJackpotSlider;
