...
function CasinoBonusbuySlider(props) {
	...
	return (
		<div>
			<div className=' relative bg-orange-800 w-full overflow-x-hidden py-5 px-5 space-y-5'>
...
export default CasinoBonusbuySlider;
